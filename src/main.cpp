...
int64 nChainStartTime = 1424520000;
...
const string strMessageMagic = "RiskCoin Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in RiskCoin
    bool fStrictPayToScriptHash = true; // Always active in RiskCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "RiskCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Take a RISK";
        CTransaction txNew;
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0x4ddc1d27083e5426a757c8e3f6adeb6eec12e551eae0cc322458c41800d58162"));
